...
figure6 <- figure6_data |> 
  ...
  geom_text(data = filter(figure6_data, proportion>0),
            ...
            hjust = -0.1, 
            size = 3.5) +
  scale_x_continuous(expand = c(0, 0), breaks = c(0, 50, 100, 200, 300, 400, 500, 600, 700, 800), 
                     limits = c(0, max_count * 1.2),
                     labels = c(0, 50, 100, 200, 300, 400, 500, 600, 700, 800)) +
...
ggsave('~/github/ICEDPaper1/plots/Figure3.png', plot = figure6, width = 8, height = 5, units="in", limitsize = TRUE, scale = 1.2, dpi = 300, bg = "white")
rm(figure6)
# ggsave('/Users/alexisbahl/Documents/Github/Paper1UncertaintiesRecruitment/plots/Figure6.png',
#        plot = figure6, width = 8, height = 5, units="in", limitsize = TRUE, scale = 1.2, dpi = 300, bg = "white")

#----------------------------------------------------
# FIGURE - SEASONAL DATA COUNTS
# let's also produce a timeline of the seasonal distribution of the extracted studies
#read_csv('~/github/ICEDPaper1/data/parameterClassifications20231109.csv') %>% 
fig2b <- read_csv('/Users/alexisbahl/Documents/Github/Paper1UncertaintiesRecruitment/data/parameterClassifications20231109.csv') |> 
  ...
  geom_col(width = 0.8) +
  labs(x = "\n Season", y = '\n Number of studies') +
  scale_y_continuous(expand = c(0, 0 + 1), breaks = c(0,25,50,75,100)) +
...
max_count_spawn <- max(spawningData$count)

figure3a <- spawningData %>% 
  ...
  scale_x_continuous(expand = c(0, 0), breaks = c(0, 50, 100, 150, 200, 250, 300), 
                     limits = c(0, max_count_spawn* 1.2),
